            ...
            axios
                ...
                .then(
                    response => {
                        ...
                        link.setAttribute(
                            "download",
                            `Phiếu thu_${item.CodeTicket}.xlsx`
...
export const saveWeightStone = () => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
            ...
            axios
                .post(
                    `${Config.API_URL_USER}ticket_proc/insert_list_stone_waxset`,
...
export const getListOutputByCustomer = () => {
    return (dispatch, getState) => {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `${Config.API_URL_USER}cash_trans/get_list_output_by_customer`,
...
export const getListStoneWaxsetByIdBag = obj => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
            ...
            axios
                .get(
                    `${Config.API_URL_USER}ticket_proc/get_list_stone_waxset_bag`,
                    {
...
export const getConfigProcess = value => {
    return (dispatch, getState) => {
        ...
        dispatch({
            ...
            payload: {
                objConfig:
                    (list_config_processTemp && list_config_processTemp[0]) ||
                    {}
            }
        });
    };
            ...
            if (parseInt(item.index) === parseInt(obj.id)) {
                ...
                switch (obj.key) {
                    ...
                    case "Product_Weight_OUT":
                        item["Gold_Weight_OUT"] =
                            valueTemp * Broken_Weight_OUTTemp -
                            Waxset_WeightTemp;
                        break;
                    // tương tự trường hợp OUT
                    case "Product_Weight_IN":
                        item["Gold_Weight_IN"] =
                            valueTemp * Broken_Weight_INTemp -
                            Waxset_WeightTemp;
                        break;
                    default:
                        break;
...
export const getListDataCashTrans = (
    ...
    return (dispatch, getState) => {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(`${Config.API_URL_USER}cash_trans`, {
                    params: {
                        page: page,
                        total: total,
                        key: value,
...
export const getDataDetailStoneByCode = (value = "") => {
    return (dispatch, getState) => {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `${Config.API_URL_USER}ticket_proc/get_ticket_detail_stone`,
                    { params: { CodeTicket: objData.CodeTicket } }
                )
                .then(
                    response => {
