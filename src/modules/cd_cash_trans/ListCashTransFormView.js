...
import * as CashTransActions from 'modules/cd_cash_trans/actions/form'
...
class ListCashTransFormView extends React.Component {
    ...
    render() {
        let { list_data, listHeaderTable, objConfig } = this.props.cd_cash_trans
