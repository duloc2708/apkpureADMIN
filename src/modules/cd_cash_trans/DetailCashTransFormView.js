...
import * as cachTransActions from 'modules/cd_cash_trans/actions/form'
...
class DetailCashTransFormView extends React.Component {
    ...
    ChangeValueCombobox(obj) {
        let { id, value } = obj
        let { objData } = this.props.cd_cash_trans
    ...
    componentDidMount() {
        ...
        let { Status } = this.props.cd_cash_trans.objData
    ...
    render() {
        let { IdTicket
            ...
            SaleMan,
            SaleManName,
            nameCustomer } = this.props.cd_cash_trans.objData
        let { list_user, objConfig, listCustomer, listOutput } = this.props.cd_cash_trans
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <div className="form-group">
                                            ...
                                            <div className="right" >
                                                <Combobox type_code='PAYMENT_TYPE' value={Payment_Type} id='Payment_Type' parentObject={this} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
