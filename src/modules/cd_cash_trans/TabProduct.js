                        ...
                        {listOutputByCustomer && listOutputByCustomer.map((item, i) => {
                            ...
                            return (
                                <tr key={`data_${i}`} id={`tr_${index}`}>
                                    ...
                                    <td>{SportConfig.function._formatGold(total_gold_adjust)}</td>
                                    <td>{SportConfig.function._formatGold(total_gold)}</td>
                                    <td>{SportConfig.function._formatGold(total_gold_10_adjust)}</td>
                                    <td>{nameLAI}</td>
                                    <td>{ValueLAI}</td>
                                </tr>)
                            // }
