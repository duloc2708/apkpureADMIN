                ...
                <table className="table table-striped" id={idTable}>
                    <thead>
                        <tr>
                            ...
                            <th style={{ "textAlign": "left" }} key={`thead_${8}`} scope="col">{'TLTB tham chiếu'}</th>
                    ...
                    <tbody>
                        {list_stone_save.map((item, i) => {
                            let { IdStone, Color, value, Weight, PrimaryStone, IdProduct, IdProductColorStone,
                                ...
                                TypeStone, AvgStone, IdProductParentIdProductStoneColor, TypeSplitStone, sl,AvgWeight } = item
                            AvgStone = Weight / sl2
