...
const INITIAL_STATE = {
    ...
    listHeaderTable: [
        ...
        // { key: 'Output_Amount', title: 'Tiền công', type: 'text', format: '', class: '', icon: '', sort: true, sortBy: '', filter: true },
        // { key: 'Output_Weight_10', title: 'TL vàng', type: 'text', format: 'gold', class: '', icon: '', sort: true, sortBy: '', filter: true },
        { key: 'WeightGold', title: 'TL vàng', type: 'text', format: 'gold', class: '', icon: '', sort: true, sortBy: '', filter: true },
        { key: 'Exchange', title: 'Tỷ giá', type: 'text', format: 'money', class: '', icon: '', sort: true, sortBy: '', filter: true },
        { key: 'PaymentAmount_1', title: 'Khách trả', type: 'text', format: 'money', class: '', icon: '', sort: true, sortBy: '', filter: true },
        { key: 'Payment_Type_Name', title: 'Hình thức', type: 'text', format: '', class: '', icon: '', sort: true, sortBy: '', filter: true },
