                ...
                <div className="row">
                        ...
                        <div className="form-group">
                            ...
                            <div className="right" >
                                <select disabled={status == 'EDIT' ? true : false} onChange={(e) => this._onChangeValue(e)} value={PriceType} >
                                    ...
                                    {list_pricetype && list_pricetype.map((item, i) => {
                                        let { value, text } = item
                                        return (
                    ...
                    <div className="col-md-4">
                        <div className="form-group">
                            ...
                            <div className="right">
                                <input readOnly={status == 'EDIT' ? true : false} readOnly={PriceType != '2' ? false : true} className="name form-control" value={Ratio} onChange={(e) => this._onChange(e)} type="text" id="Ratio" name="name" required="" /><span className="wpcf-not-valid-tip wpcf-display-none" ></span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="form-group">
                            ...
                            <div className="right">
                                <input readOnly={status == 'EDIT' ? true : false} readOnly={PriceType == '3' ? false : true} className="name form-control"
                                 value={valueLAI} onChange={(e) => this._onChange(e)} type="text" id="valueLAI" name="name" required="" /><span className="wpcf-not-valid-tip wpcf-display-none" ></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="form-group">
                            ...
                            <div className="right">
                                <input readOnly={status == 'EDIT' ? true : false} readOnly={PriceType == '3' ? false : true} className="name form-control"
                                value={VAT} onChange={(e) => this._onChange(e)} type="text" id="VAT" name="name" required="" /><span className="wpcf-not-valid-tip wpcf-display-none" ></span>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-4">
                        <div className="form-group">
                            <div className="left">
                                <label htmlFor="name">Giá vàng/Chỉ</label>
                            </div>
                            <div className="right">
                                <input readOnly={status == 'EDIT' ? true : false} readOnly={PriceType == '3' ? false : true} className="name form-control"
                                value={GoldRate} onChange={(e) => this._onChange(e)} type="text" id="GoldRate" name="name" required="" /><span className="wpcf-not-valid-tip wpcf-display-none" ></span>
                            </div>
                        </div>
                    </div>
                </div>
...
export default ReactRedux.connect(mapStateToProps, mapDispatchToProps)(ComponentDetail)
