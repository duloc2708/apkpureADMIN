            ...
            switch (valueTemp) {
                        ...
                        if (this._validateSave()) {
                            this.props.validateOutput(objDataOutput.IdOrder).then(res => {
                                ...
                                if (data.length == 0) {
                                    ...
                                    dispatch(loadingSaveOutput(false))
                                    let strIdOutPut = ''
                                    data.map(item => {
                    ...
                    if (status == 'EDIT') {
                        ...
                        if (this._validateSave()) {
                            this.props.validateOutput(objDataOutput.IdOrder).then(res => {
                                ...
                                if (data.length == 0) {
                                    this.props.getNumberAutoOutput().then(() => {
                                        this.props.updateButtonToolbar('EDIT').then(res => {
                                            this.props.addNewItemOutput(ListProduct_temp_new).then(() => {
                                                //Cap nhat lai trong luong san pham bo
                                                const { objDataOutput } = this.props.output
                                                this.props.UpdateProductWeightReal(objDataOutput.IdOutput)
                ...
                case "EDIT":
                      if (objDataOutput.IdOutput) {
                        ...
                        this.props.isEditOutPut(true)
                        this.props.updateButtonToolbar(valueTemp)
                        this.props.clickCheckRowOrder(objDataOutput, true)
                        this.props.getListDataOrderInOutPutEdit(objDataOutput.IdOrder)
                    } else {
                        isStatus = false
