        ...
        temp.map((item, i) => {
            ...
            if (obj.key == "NumberTemp") {
                ...
                if (WeightProduct && Weight) {
                    ...
                    let perCurrent = ((WeightProduct - Weight) / 0.0375) / obj.value
                    let perWeight = ((WeightProduct - WeightPro) / 0.0375) / obj.value
                    let perWeightReal = ((WeightProduct - WeightRealPro) / 0.0375) / obj.value
                    item["PerCompare"] = parseInt(perCurrent - perWeight)
                    item["PerCompareReal"] = parseInt(perCurrent - perWeightReal)
                }
                ...
                if (item.sttOther == obj.id) {
                    ...
                    if (obj.key == 'Weight') {
                        ...
                        let perWeight = ((WeightProduct - WeightPro) / 0.0375) / NumberTemp
                        let perWeightReal = ((WeightProduct - WeightRealPro) / 0.0375) / NumberTemp
                        item["PerCompare"] = parseInt(perCurrent - perWeight)
                        item["PerCompareReal"] = parseInt(perCurrent - perWeightReal)
                    }
                    if (obj.key == 'WeightProduct') {
                        ...
                        let perWeight = ((obj.value - WeightPro) / 0.0375) / NumberTemp
                        let perWeightReal = ((obj.value - WeightRealPro) / 0.0375) / NumberTemp
                        item["PerCompare"] = parseInt(perCurrent - perWeight)
                        item["PerCompareReal"] = parseInt(perCurrent - perWeightReal)
                    }
