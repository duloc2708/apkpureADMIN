                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="form-group">
                                    ...
                                    <b>
                                        Example:{" "}
                                        {`SELECT code AS "code", name as "name" FROM OTHER_LIST WHERE type_code='DSM'`}{" "}
                                    </b>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="form-group">
                                ...
                                <div className="right">
                                    <button onClick={() => this._onAddParams()}>
                                        Thêm tham số
                                    </button>
                                </div>
                            </div>
...
const mapStateToProps = ({ createReport, i18n }, ownProps) => {
    return {
        createReport,
        i18n
    };
