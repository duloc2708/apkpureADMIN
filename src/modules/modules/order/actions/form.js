...
export const getListDataBaoGiaInOrder = (params = { page: 1, total: 10 }) => {
...
export const getListPriceByPriceCode = (PriceCode) => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
            axios.get(`${Config.API_URL_USER}baogia/get_list_products`, { params: { page: 1, total: 100000, PriceCode: PriceCode } })
                .then((response) => {
                    let { data } = response.data
...
export const getListCustomer = (params) => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
            axios.get(`${Config.API_URL_USER}customer`, { params: { page: 1, total: 10000 } })
                .then((response) => {
                    let { data } = response.data
                    dispatch({
...
export const getListDataBySearch = (value) => {
    return (dispatch, getState) => {
        return new Promise((resolve, reject) => {
            axios.get(`${Config.API_URL_USER}order/search`, { params: { page: 1, total: 10, key: value } })
                .then((response) => {
                    let { data } = response.data
                    let data_temp = data
                    data_temp.map(item => item.checked = false)
...
export const getListDataOrder = (params = { page: 1, total: 10 }) => {
    return (dispatch, getState) => {
        ...
        return new Promise((resolve, reject) => {
            axios.get(`${Config.API_URL_USER}order/get_auto_number`)
                .then((response) => {
                    ...
                    let default_product_temp = _.clone(default_product, true)
                    let objDataOrder_temp = _.clone(objDataOrder, true)
                    let numberGen = (data && data[0].value || '0000000') + '-' + (IdCustomer || '')
