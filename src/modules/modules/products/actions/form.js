    ...
    return (dispatch, getState) => {
        ...
        return new Promise((resolve, reject) => {
            Promise.all([
                ...
                axios.post(`${Config.API_URL_USER}products/get_list_casting`, { IdProduct: objData.Id }),
                axios.post(`${Config.API_URL_USER}products/get_list_price`, { IdProduct: objData.Id, page: 1, total: 1000 })
            ])
                .then((response) => {
...
export const getListDataProductsBySearch = (value = '') => {
    return (dispatch, getState) => {
        let { page, total } = getState().products
        dispatch({
        ...
        return new Promise((resolve, reject) => {
            axios.post(`${Config.API_URL_USER}products/search`, { page: 1, total: 10, key: value })
                .then((response) => {
                    let { data } = response.data
                    let data_temp = data
...
export const getListDataProducts = (params = { page: 1, total: 10 }) => {
    return (dispatch, getState) => {
