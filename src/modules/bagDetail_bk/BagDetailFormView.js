                    ...
                    columns: [
                        {
                            ...
                            table: {
                                headerRows: 1,
                                widths: checkSplit > 0 ? [117, 160, 68] : [110, 150, 90],
                                body: [
                                    [
                                        'Bag No: ' + (Id || ''),
                                        'Item: ' + (IdProduct || ''),
                                            ...
                                            body: [
                                                [
                                                    "Lẻ",
                                                    {
                                                        ...
                                                        width: 9,
                                                        height: parseInt(CountOfStone)<14?20:12, 
                                                        margin: [0, 0, 0, 0]
                                                    },
                                                    "Bộ",
                                                    {
                                    ...
                                    [{
                                        ...
                                        height: parseInt(CountOfStone) <14?40:15,
                                        colSpan: 2,// decoration: 'underline'
                                        fontSize: parseInt(CountOfStone) < 17 ? 9 : 7.5
                    ...
                    columns: [
                        {
                            ...
                            table: {
                                headerRows: 1,
                                widths: checkSplit > 0 ? [117, 154, 80] : [110, 155, 85],
                                body: [
                                    [
                                        'Bag No: ' + (Id || ''),
                                            ...
                                            body: [
                                                [
                                                    ...
                                                    "Bộ",
                                                    {
                                                        image: type_bag == 'STATUS_BAG_PRODUCT_02' ? imgCheck : imgUnCheck,
                                                        width: 9,
                                                        height: parseInt(CountOfStone)<14?30:12, 
                                                        margin: [0, 0, 0, 0]
                                                    }
                                                ]
                                            ]
                                    ...
                                    [{
                                        text: 'Casting ' + (Casting || ''),
                                        height: parseInt(CountOfStone) <14?40:10,
                                        colSpan: 2, //decoration: 'underline',
                                        fontSize: parseInt(CountOfStone) < 17 ? 9 : 7.5                                        
                                    }, ''
                                    ],
