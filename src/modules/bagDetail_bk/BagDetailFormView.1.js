                        ...
                        arr.push(<tr style={{ "textAlign": "center" }} key={`tr_data_total_${item2.Weight}`}>
                            {list_stone_by_color && list_stone_by_color.map((item, i) => {
                                ...
                                if (Weight_Temp && item.ColorCode!='001') {
                                    arr_td_value.push(this.round(Weight_Temp, 4) + '|' + this.round(Weight_Temp / 0.0375, 1))
                                } else {
                                    arr_td_value.push('')
                                }
                            })}
                ...
                if (ii == get_list_stone_detail.length - 1) {
                    ...
                    arr.push(<tr style={{ "textAlign": "center" }} key={`tr_data_total_${item2.Weight}`}>
                        {list_stone_by_color && list_stone_by_color.map((item, i) => {
                            ...
                            if (Weight_Temp && item.ColorCode!='001') {
                                arr_td_value_3.push(this.round(Weight_Temp, 4) + '|' + this.round(Weight_Temp / 0.0375, 1))
                            } else {
                                arr_td_value_3.push('')
                            }
           ...
           // console.log('>>>>>>>>>> truongnn', checkSplit);
            ...
            if (type == 'A4') {
                arr_data_pdf.push({
                    columns: [
                        {
                            width: list_value_color_header.length > 4?'64%':'64%',
                            table: {
                                headerRows: 1,
                                widths: checkSplit > 0? [115, 160, 68]:[96, 170, 80],
                                body: [
                                    [
                                        'Bag No: ' + (Id || ''),
                                        'Item: ' + (IdProduct || '' ),
                                        {
                                            ...
                                            width: list_value_color_header.length > 4?90:90,
                                            height: 80,
                                            rowSpan: 5,
                                            margin: [0, 0, 0, 0]
                                        },
                                    ...
                                    [
                                        {
                                            ...
                                            fontSize: list_value_color_header.length > 4 ? 7.5 : 7.5,
                                            layout: 'noBorders',
                                        }
                                        ,
                                        {
                    ...
                    columns: [
                        {
                            ...
                            table: {
                                headerRows: 1,
                                widths: checkSplit > 0? [115, 164, 70]:[100, 172, 78],
                                body: [
                                    [
                                        'Bag No: ' + (Id || ''),
                                        'Item: ' + (IdProduct || '' ) + ' - Qty: ' + (QtyCreated || ''),
                                        {
                                            image: `data:image/jpg;base64,${url_image}`,
