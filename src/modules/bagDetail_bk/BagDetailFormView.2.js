...
class BagDetailFormView extends React.Component {
    ...
    generatePDF() {
        ...
        html2canvas($(".print-wrap:eq(0)")[0], {
            ...
            // scale: 100, // Adjusts your resolution
            onrendered: function (canvas) {
                ...
                pdf.addImage(imgData, 'jpg', 3, 3, HTML_Width, HTML_Height);
    ...
    render() {
        ...
        list_report_bag && list_report_bag.map((item, i) => {
            ...
            arr_data.push(
                ...
                <table className="print-wrap" key={Id} style={{ "background": "white", "fontSize": "13px", "paddingBottom": "250px" }}  >
                    <tbody>
                        <tr>
                            {/*  */}
                            {/*  Bag common info */}
                            <td style={{ "border": "2px solid black", "verticalAlign": "top" }}>
                                    ...
                                    <tbody>
                                        <tr style={{ "fontSize": "13px" }}>
                                            ...
                                            <td rowSpan="4" style={{ "textAlign": "right", "paddingLeft": "5px" }}>
                                                <div style={{ "border": "2px solid black", "display": "inline-block", "padding": "2px 2px", "textAlign": "right" }}>
                                                    <img src={`data:image/jpeg;base64,${url_image}`} width="90" height="95" verticalAlign="left" />
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>Order:<strong> {IdOrder}</strong> </td>
                                        ...
                                        <tr style={{ "fontSize": `${list_stone_by_color.length >= 3 ? '11px' : "13px"}` }}>
                                            <td colSpan="1" style={{ "width": `${list_stone_by_color.length >= 3 ? '160px' : "180px"}` }}>
                                            ...
                                            {list_stone_by_color.length > 0 ?
                                                <td colSpan="2" style={{ "fontSize": `${list_stone_by_color.length >= 3 ? '11px' : "13px"}` }} >
                                                    <table  >
                                                        <thead>
                                                            <tr>
                                                                {
                                                                        ...
                                                                        if (IdProduct_temp2 && IdProduct_temp2 != findNextProduct.IdProduct) {
                                                                            arr.push(<tr style={{ "textAlign": "center" }} key={`tr_data_total_${item2.Weight}`}>
                                                                                {list_stone_by_color && list_stone_by_color.map((item, i) => {
                                                                                    ...
                                                                                    return (
                                                                                        ([<td key={`td_data_${ii}_${i}`} style={{ "fontWeight": "bold", "paddingLeft": "5px" }}>
                            ...
                            {/*  Bag processes */}
                            <td style={{ "border": "2px solid black", "verticalAlign": "top", "width": `${list_stone_by_color.length >= 3 ? '270px' : "320px"}`, "fontSize": `${list_stone_by_color.length >= 3 ? '11px' : "13px"}` }}>
                                <table className="table head" >
                                    <thead >
                                        <tr >
                                            <th className="normal-width" style={{ "border": "1px solid black" }}>Khâu</th>
                                            <th className="small-width" style={{ "border": "1px solid black" }}> </th>
                                            <th className="small-width" style={{ "border": "1px solid black" }}>Vàng + Đá (Gram) </th>
                                            <th className="small-width" style={{ "border": "1px solid black" }}>Tổng TL đá rớt (Gram)</th>
                                            <th className="small-width" style={{ "border": "1px solid black" }}>TL Vàng (Gram)</th>
                                    ...
                                    <tbody>
                                        {listKey.map((item, i) => {
                                            if (item.pos == 0) {
                                                return (
                                                    <tr key={`listKey_${i}`} >
                                                        <td rowSpan="2" style={{ "border": "1px solid black", "verticalAlign": "middle" }}>{item.name}</td>
                                                        <td style={{ "border": "1px solid black" }}>Đi</td>
                                                ...
                                                return (
                                                    <tr key={`listKey_${i}`} >
                                                        <td style={{ "border": "1px solid black" }}>Đến</td>
                                                        <td style={{ "border": "1px solid black" }}></td>
                                                        <td style={{ "border": "1px solid black" }}></td>
                                                        <td style={{ "border": "1px solid black" }}></td>
                                                    </tr>
            ...
            <div className="container" style={{ "background": "white" }}>
                <section >
                    ...
                    <div className="main__content bag_report" >
                        <fieldset>
                            <p style={{ "background": "white", "paddingLeft": "5px", "paddingTop": "5px" }} >
                                <a >
                            ...
                            <div style={{ "background": "white", "paddingLeft": "5px", "paddingTop": "5px" }} id="bag_report">
                                {arr_data}
                            </div>
