                        ...
                        {list_stone_save.map((item, i) => {
                            ...
                            return (
                                <tr key={`dataDetail_${i}`}>
                                    ...
                                    <Cell type="text" width="100px" value={Weight} keyInput="value" id={itemDetailCreateBag.IdOdd == "1" ? IdProductParentIdProductStoneColor : IdProductColorStone} parentObject={this} />
                                    <td >
                                        {exchange}
                                    </td>
                                    <td style={{ "textAlign": "left" }}>
