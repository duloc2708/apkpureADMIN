                ...
                <table className="table table-striped">
                    ...
                    <tbody>
                        {list_stone_save.map((item, i) => {
                            let { IdStone, Color, numofstone, value, Weight, PrimaryStone, IdProduct, IdProductColorStone, IdProductColorParentColorStone, ColorParent, IdProductParent, sl2, exchange, TypeStone, AvgStone, IdProductParentIdProductStone,sl } = item
                            AvgStone = Weight / sl2
                            return (
