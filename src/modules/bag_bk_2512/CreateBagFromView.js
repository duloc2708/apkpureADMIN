...
import TabOrder from './ModalFormCreatebag'
...
class ModalFormCreatebag extends React.Component {
    constructor() {
        super();
    }
    afterOpenModal() {
            ...
            if (type == 2) {
                ...
                if (r == true) {
                    ...
                    if (listItemCreateBag_temp.length > 0) {
                        this.props.InsertBagList(listItemCreateBag[0].IdOrder, statusWeight).then(res => {
...
export default ReactRedux.connect(mapStateToProps, mapDispatchToProps)(ModalFormCreatebag)
