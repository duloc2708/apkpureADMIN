...
class ModalUpdateBag extends React.Component {
    ...
    render() {
        ...
        let Id_temp, IdOrder_temp, DateCreated_temp, DateProcess_temp, EmployeeId_temp, Remark, type_bag_temp, TypeSplitStoneTemp;
        if (listItemCreateBag.length > 0) {
            let { Id, IdOrder, DateCreated, DateProcess, EmployeeId, Remark, type_bag, TypeSplitStone } = listItemCreateBag[0];
            Id_temp = Id;
                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        <div className="form-group">
                            ...
                            <div className="right">
                                <Combobox disable={true} type_code='TYPE_SPLIT_STONE' id='TypeSplitStone' value={TypeSplitStoneTemp} parentObject={this} />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-3">
