...
class CastingFormView extends React.Component {
    ...
    render() {
        ...
        let { IdMould, Name, Numb, WeightWax, WeightGold } = this.props.casting.objData
        return (
                        ...
                        <div className="form__personnal">
                            ...
                            <div className="row">
                                <div className="col-md-4">
                                    <div className="form-group ">
                                        <div className="left">
                                            <label htmlFor="name">Trọng lượng sáp(gr)</label>
                                        </div>
                                        <div className="right">
                                            <input className="name form-control"
                                                value={WeightWax}
                                ...
                                <div className="col-md-4">
                                    <div className="form-group">
                                        <div className="left">
                                            <label htmlFor="name">Trọng lượng vàng(chỉ)</label>
                                        </div>
                                        <div className="right">
                                            <input className="name form-control"
                                                type="number"
                                                value={Helper.round(WeightWax*3.7,4)}
                                                onChange={(e) => this._handleInput(e)}
                                                ref="WeightGold"
                                                id="WeightGold"
                                                name="WeightGold"
                        ...
                        <table className="table table-striped">
                            ...
                            <tbody>
                                ...
                                {list_data && list_data.map((item, i) => {
                                    let { IdMould, Name, Numb, checked, WeightWax, WeightGold } = item
                                    return (
