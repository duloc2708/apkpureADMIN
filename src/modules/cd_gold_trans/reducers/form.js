...
const INITIAL_STATE = {
    ...
    listHeaderGoldCustom: [
        ...
        {
            key: "PaymentWeightGram",
            title: "TL vàng khách trả(gram)",
            type: "inputNumber",
            format: "",
            class: "",
            icon: "",
        ...
        {
            key: "PaymentWeight_RealGram",
            title: "TL vàng thực cân(gram)",
            type: "inputNumber",
            format: "",
            class: "",
            icon: "",
        ...
        {
            key: "PaymentWeight10_Real",
            title: "Quy thực tế trả vàng 10(chỉ)",
            type: "text",
            format: "gold",
            class: "",
            icon: "",
