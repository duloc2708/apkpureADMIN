...
class TabProduct extends React.Component {
    ...
    _onKeyPressCheckBag(e, IdBag, index) {
        let that = this
        if (e.key == 'Enter') {
            let { listBagSelected, list_bag_default, objDataOrder, list_products_by_baogia, objConfig, objData } = this.props.cd_gold_trans
    ...
    render() {
        ...
        let { listHeaderBag, listOutputByCustomer, isEditProducts, isShowStone, objConfig, listHeaderOutputOfCus } = this.props.cd_gold_trans
