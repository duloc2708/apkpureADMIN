    ...
    return (
      ...
      >
        <ComboboxListProducts
          type={"products"}
          list_data={listProductsCombobox}
        />
            ...
            {listProductsSelected &&
              listProductsSelected.map((item, i) => {
                ...
                if (value && value.length > 0) {
                  let WeightTotal = Helper.roundNumber(
                    WeightReal || Weight || 0,
                    4
                  );
                  return (
                    <tr key={`data_${i}`}>
                      ...
                      <td style={{ textAlign: "center" }}>
                        {Helper.roundNumber(Weight || 0, 4)}
                      </td>
                      <td style={{ textAlign: "center" }}>
                        {Helper.roundNumber(WeightReal || 0, 4)}
                      </td>
...
const mapStateToProps = (
  { userAuth, i18n, casting, header, products },
  ownProps
) => {
  return {
    userAuth,
