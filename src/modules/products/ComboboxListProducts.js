...
class ComboboxListProducts extends React.Component {
    constructor() {
        super()
    }
    ...
    render() {
        ...
        list_data.map((item) => {
            if (item.Id)
                arr_temp.push({ value: item.Id, label: item.Name, Image: item.Image, price: 99000 })
        })
        return (
...
export default ReactRedux.connect(mapStateToProps, mapDispatchToProps)(ComboboxListProducts)
